        ...
        <section className='mx-auto flex w-11/12 max-w-maxContent justify-between gap-12 text-richblack-500 mt-12'>
            ...
            <div className='flex flex-col w-[55%] gap-10'>
                ...
                <div className='flex flex-col gap-5 text-base font-medium text-richblack-300 lg:w-[95%]'>
                    <p>Our e-learning platform was born out of a shared vision and passion for transforming education. It all began with a group of educators, technologists, 
                    ...
                    <p>As experienced educators ourselves, we witnessed firsthand the limitations and challenges of traditional education systems. We believed that education should not 
                    be confined to the walls of a classroom or restricted by geographical boundaries. We envisioned a platform that could bridge 
        ...
        <section className='mx-auto flex w-11/12 max-w-maxContent justify-between gap-10 text-richblack-500 mt-34'>
            ...
            <div className="my-24 flex lg:w-[45%] flex-col gap-6">
                ...
                <div className="text-base font-medium text-richblack-300 lg:w-[95%]">
                    With this vision in mind, we set out on a journey to create an e-learning platform that would revolutionize the way people learn. Our team of dedicated experts worked tirelessly to develop a 
                    robust and intuitive platform that combines cutting-edge technology with engaging content, fostering a dynamic and interactive learning experience.
                </div>
            ...
            <div className="my-24 flex lg:w-[45%] flex-col gap-6">
                ...
                <div className="text-base font-medium text-richblack-300 lg:w-[95%]">
                    our mission goes beyond just delivering courses online. We wanted to create a vibrant community of learners, where individuals can connect, collaborate, and learn from one another. We believe that knowledge thrives 
                    in an environment of sharing and dialogue, and we foster this spirit of collaboration through forums, live sessions, and networking opportunities.
                </div>
